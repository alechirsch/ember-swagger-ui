...
module.exports = {
  ...
  included: function(app) {
    ...
    app.import(app.bowerDirectory + '/swagger-ui/dist/lib/lodash.min.js', { exports: { 'lodash-compat': ['default']}});
    ...
    app.import(app.bowerDirectory + '/swagger-ui/dist/lib/highlight.9.1.0.pack_extended.js', { exports: { 'hljs': ['default']}});
